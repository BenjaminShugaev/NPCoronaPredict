...
#SBATCH --job-name=dryslab
#SBATCH --output=drylab_run.out
#SBATCH --error=dryslab_run.err
...
gmx_mpi grompp -f step7.1_nvt.mdp -c nowater.gro -p dryslab.top -o dryslab.tpr
gmx_mpi mdrun -s dryslab.tpr -deffnm dryslab
